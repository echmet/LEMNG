...
int main(int , char ** )
{
	...
	checkEigenzone(1, r.eigenzones, -3.8691823131e-15, -2.5919563403e-16, 0.51385140826, 3.7525300656, 0.05139957837);

	checkEigenzone(2, r.eigenzones, -4.3684723305e-07, -4.4307853442e-07, 1.2680782754, 3.9803824683, 0.035786599545);

	checkEigenzone(3, r.eigenzones, -5.1680968568, -1.4356099055, 0.1327816924, 3.7713378642, 0.046563498837);

	checkEigenzone(4, r.eigenzones, 21.206795057, 5.4496673668, 1.091388496, 3.6056789559, 0.048977534538);
