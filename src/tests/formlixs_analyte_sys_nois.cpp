...
int main(int , char ** )
{
	...
	checkEigenzone(r.eigenzones, -0.012266406199, -0.070470519961, 0.48236767171, 3.4132556214, 0.059908842156);

	checkEigenzone(r.eigenzones, 1.7080460734, 1.7339668748, 0.79204805167, 11.151567718, 0.034717917459);

	checkEigenzone(r.eigenzones, -11.033657892, 3.2374034446, 0.72045431567, 3.4646248412, 0.058084284903);

	checkEigenzone(r.eigenzones, 33.42827756, 4.2339445103, 1.1643726698, 3.3831603772, 0.050576459137);
