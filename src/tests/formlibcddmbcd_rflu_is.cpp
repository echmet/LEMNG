...
int main(int , char ** )
{
	...
	checkEigenzone(r.eigenzones, -5.6304324029e-16, -1.0241369556e-17, 0.51385140826, 3.7525300653, 0.051399578406);

	checkEigenzone(r.eigenzones, -1.5779375901e-14, -1.3493717328e-18, 0.51385140826, 3.7525300653, 0.051399578407);

	checkEigenzone(r.eigenzones, -4.3950460109e-07, -5.3924590863e-07, 1.2680782754, 4.0871952348, 0.032149385581);

	checkEigenzone(r.eigenzones, -1.6425123101, -0.15500431725, 0.21638148291, 3.7634763459, 0.049966974595);

	checkEigenzone(r.eigenzones, 21.20679506, 5.1917446903, 1.091388496, 3.6122141437, 0.049078886009);
