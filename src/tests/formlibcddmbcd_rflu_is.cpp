...
int main(int , char ** )
{
	...
	checkEigenzone(r.eigenzones, -5.6304324029e-16, -1.0382233868e-17, 0.51385140826, 3.7525300653, 0.051399578406);

	checkEigenzone(r.eigenzones, -1.5779375901e-14, -1.309953715e-18, 0.51385140826, 3.7525300653, 0.051399578407);

	checkEigenzone(r.eigenzones, -4.3673515708e-07, -5.3682658999e-07, 1.2680782754, 4.0871952346, 0.032149385576);

	checkEigenzone(r.eigenzones, -1.6425123101, -0.15500431692, 0.21638148291, 3.7634763458, 0.049966974598);

	checkEigenzone(r.eigenzones, 21.206795057, 5.1917446861, 1.091388496, 3.6122141438, 0.04907888601);
