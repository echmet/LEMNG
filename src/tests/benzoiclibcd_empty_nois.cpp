...
int main(int , char ** )
{
	...
	checkEigenzone(r.eigenzones, -8.7070560173e-08, -2.054598111e-08, 0.56008911117, 4.0001277163, 0.069854385856);

	checkEigenzone(r.eigenzones, -0.60094175857, -0.094933755149, 0.59564769328, 3.9905125767, 0.069862350483);

	checkEigenzone(r.eigenzones, 6.372230561, 1.4133711229, 1.020208106, 3.9097796852, 0.069633985664);
