...
int main(int , char ** )
{
	...
	checkEigenzone(1, r.eigenzones, -8.7143910496e-08, -2.0558765049e-08, 0.56008911114, 4.0001277162, 0.069854385855);

	checkEigenzone(2, r.eigenzones, -0.60094175858, -0.09493375514, 0.59564769332, 3.9905125766, 0.069862350481);

	checkEigenzone(3, r.eigenzones, 6.3722305581, 1.4133711214, 1.020208106, 3.9097796852, 0.069633985668);
