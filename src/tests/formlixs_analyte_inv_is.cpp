...
int main(int , char ** )
{
	...
	checkEigenzone(1, r.eigenzones, -1.6124697662e-15, -1.0844943009e-16, 0.51385140826, 3.7525300653, 0.051399578407);

	checkEigenzone(2, r.eigenzones, -4.3684723305e-07, -5.0886101286e-07, 1.2680782754, 4.050382941, 0.033254934945);

	checkEigenzone(3, r.eigenzones, -10.128331975, -0.74266661947, 0.26022288244, 3.7512294009, 0.048914937445);

	checkEigenzone(4, r.eigenzones, 21.206795057, 5.5081075415, 1.091388496, 3.6042029176, 0.048954771308);
