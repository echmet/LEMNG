...
int main(int , char ** )
{
	...
	checkEigenzone(r.eigenzones, -6.9299828355e-16, -1.1434916256e-17, 3.7807882258, 0.053349365975);

	checkEigenzone(r.eigenzones, -1.5646500865e-14, -1.2211952908e-18, 3.7807882258, 0.053349365976);

	checkEigenzone(r.eigenzones, -4.5867216446e-07, -5.5970689774e-07, 4.1069236188, 0.033423472056);

	checkEigenzone(r.eigenzones, -1.6362978402, -0.1618570358, 3.7917921482, 0.051754096244);

	checkEigenzone(r.eigenzones, 19.791803186, 5.3115949738, 3.6378241545, 0.050359139763);
