...
int main(int , char ** )
{
	...
	checkEigenzone(1, r.eigenzones, -6.2261000774e-16, -1.1431151474e-17, 0.51385140826, 3.7807882258, 0.053349365975);

	checkEigenzone(2, r.eigenzones, -1.5653481447e-14, -1.3445010186e-18, 0.51385140826, 3.7807882258, 0.053349365976);

	checkEigenzone(3, r.eigenzones, -4.5657340426e-07, -5.5788050222e-07, 1.3420079091, 4.1069236186, 0.033423472052);

	checkEigenzone(4, r.eigenzones, -1.6362978402, -0.16185703553, 0.21701802171, 3.7917921482, 0.051754096246);

	checkEigenzone(5, r.eigenzones, 19.791803183, 5.3115949695, 1.1569824945, 3.6378241546, 0.050359139765);
