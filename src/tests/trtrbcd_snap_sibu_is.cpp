...
int main(int , char ** )
{
	...
	checkEigenzone(r.eigenzones, -1.2506693969e-14, -2.9906850417e-15, 0.51385140826, 8.1129381247, 0.051406531055);

	checkEigenzone(r.eigenzones, 2.9282055721e-05, 2.2928095754e-05, 0.67521102282, 7.9891111057, 0.039712786546);

	checkEigenzone(r.eigenzones, -0.014871781076, -0.0053224091981, 0.68289601206, 8.2060634036, 0.050093783482);
