...
int main(int , char ** )
{
	...
	checkEigenzone(1, r.eigenzones, 0.0088429041208, 0.0027173902486, 0.81583614629, 3.1025402684, 0.27055462645);

	checkEigenzone(2, r.eigenzones, 69.03696619, 3.6031523874, 1.102010988, 2.8522966522, 0.32016146344);
