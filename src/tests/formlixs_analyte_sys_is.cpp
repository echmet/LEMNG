...
int main(int , char ** )
{
	...
	checkEigenzone(1, r.eigenzones, -0.012316464932, -0.071355066634, 0.48439926692, 3.3886626501, 0.058292552093);

	checkEigenzone(2, r.eigenzones, 1.6600164232, 1.6372366765, 0.75444110326, 11.120187788, 0.033617883459);

	checkEigenzone(3, r.eigenzones, -10.510789143, 2.9183155611, 0.68044613415, 3.4355298748, 0.056380660082);

	checkEigenzone(4, r.eigenzones, 35.059371768, 3.2697570635, 1.0878447758, 3.3705858237, 0.049991341944);
