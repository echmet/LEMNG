...
int main(int , char ** )
{
	...
	checkEigenzone(r.eigenzones, -8.2942756636e-08, -4.2578800896e-05, 0.53089249476, 3.9609903249, 0.064158451662);

	checkEigenzone(r.eigenzones, -0.57626859052, -0.08694555013, 0.54118030444, 3.9494636186, 0.064681343274);

	checkEigenzone(r.eigenzones, 7.1865839646, 1.5900667879, 0.93040426983, 3.8681000409, 0.064339288368);
