...
int main(int , char ** )
{
	...
	checkEigenzone(r.eigenzones, -1.3628268387e-14, -3.3197318813e-15, 8.1129439047, 0.054990721317);

	checkEigenzone(r.eigenzones, 2.9589386263e-05, 2.3007734293e-05, 7.9906226088, 0.042269676753);

	checkEigenzone(r.eigenzones, -0.013684947154, -0.0049548332752, 8.2051366303, 0.053442925127);

	checkEigenzone(r.eigenzones, -9.5757296467, -0.14117121546, 8.1102003707, 0.054585775016);

	checkEigenzone(r.eigenzones, -10.494555394, -0.13574099518, 8.1102031378, 0.054641349106);
