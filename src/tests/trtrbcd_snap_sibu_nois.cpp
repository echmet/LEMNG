...
int main(int , char ** )
{
	...
	checkEigenzone(1, r.eigenzones, -1.3768487273e-14, -3.0701110757e-15, 0.51385140826, 8.1129439047, 0.054990721319);

	checkEigenzone(2, r.eigenzones, 2.9589070046e-05, 2.3007553585e-05, 0.76025734517, 7.9906226451, 0.042269677005);

	checkEigenzone(3, r.eigenzones, -0.013684946821, -0.0049548312704, 0.76843676151, 8.2051366006, 0.053442925793);

	checkEigenzone(4, r.eigenzones, -9.5757296467, -0.14117121546, 0.24617247392, 8.1102003707, 0.054585775016);

	checkEigenzone(5, r.eigenzones, -10.494555394, -0.13574099518, 0.2698264283, 8.1102031378, 0.054641349106);
