...
int main(int , char ** )
{
	...
	checkEigenzone(r.eigenzones, -3.6367562513e-16, -1.3203230253e-17, 0.51385140826, 3.7525300653, 0.051399578407);

	checkEigenzone(r.eigenzones, -4.3961648517e-07, -5.4397312563e-07, 1.2680782754, 4.0937519751, 0.031966230543);

	checkEigenzone(r.eigenzones, -1.9218729088, -0.15945839774, 0.24022475218, 3.762025126, 0.050124563127);

	checkEigenzone(r.eigenzones, 21.20679506, 5.1960316625, 1.091388496, 3.6121052417, 0.049077189672);
