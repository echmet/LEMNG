...
int main(int , char ** )
{
	...
	checkEigenzone(1, r.eigenzones, -6.715753817e-16, -1.2987600378e-17, 0.51385140826, 3.7525300653, 0.051399578406);

	checkEigenzone(2, r.eigenzones, -4.3684704003e-07, -5.4153304259e-07, 1.2680782754, 4.0937519747, 0.031966230541);

	checkEigenzone(3, r.eigenzones, -1.9218729088, -0.15945839744, 0.24022475218, 3.762025126, 0.050124563128);

	checkEigenzone(4, r.eigenzones, 21.206795057, 5.1960316583, 1.091388496, 3.6121052418, 0.049077189674);
