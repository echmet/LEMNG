...
int main(int , char ** )
{
	...
	checkEigenzone(r.eigenzones, -4.5879145461e-07, -5.287968837e-07, 1.3420079092, 4.0689839248, 0.034619983614);

	checkEigenzone(r.eigenzones, -10.163934426, -0.8742846726, 0.26113760092, 3.7777349796, 0.050532309836);

	checkEigenzone(r.eigenzones, 19.791803187, 5.5740910405, 1.1569824945, 3.6311800826, 0.050225836354);
