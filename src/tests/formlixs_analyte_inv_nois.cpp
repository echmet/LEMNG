...
int main(int , char ** )
{
	...
	checkEigenzone(r.eigenzones, -1.6124697662e-15, -1.2080938932e-16, 0.51385140826, 3.7807882258, 0.053349365977);

	checkEigenzone(r.eigenzones, -4.5669268989e-07, -5.2707166877e-07, 1.3420079092, 4.0689839245, 0.034619983611);

	checkEigenzone(r.eigenzones, -10.163934426, -0.87428467248, 0.26113760092, 3.7777349796, 0.050532309836);

	checkEigenzone(r.eigenzones, 19.791803184, 5.5740910363, 1.1569824945, 3.6311800827, 0.050225836356);
