...
int main(int , char ** )
{
	...
	checkEigenzone(r.eigenzones, -3.878495203e-15, -2.6403647093e-16, 0.51385140826, 3.780788226, 0.053349365948);

	checkEigenzone(r.eigenzones, -4.5669268989e-07, -4.5411165238e-07, 1.3420079092, 3.9971406125, 0.037383476496);

	checkEigenzone(r.eigenzones, -5.1692638366, -1.5404564032, 0.13281167511, 3.7979124956, 0.047903556566);

	checkEigenzone(r.eigenzones, 19.791803184, 5.4934081825, 1.1569824945, 3.6332187947, 0.050266650592);
