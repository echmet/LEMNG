...
int main(int , char ** )
{
	...
	checkEigenzone(r.eigenzones, -2.4976645929e-07, -3.6792715438e-07, 1.4311624749, 4.2389183872, 0.051285698972);

	checkEigenzone(r.eigenzones, 15.320782056, -9.7671951499, 1.3801252217, 4.0164006602, 0.10766747473);

	checkEigenzone(r.eigenzones, 76.19999996, -14.172314094, 1.9577738655, 3.7474959277, 0.099974144085);
