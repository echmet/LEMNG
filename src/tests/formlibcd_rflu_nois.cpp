...
int main(int , char ** )
{
	...
	checkEigenzone(r.eigenzones, -8.6458845161e-16, -1.4174876616e-17, 0.51385140826, 3.7807882258, 0.053349365975);

	checkEigenzone(r.eigenzones, -4.5879125107e-07, -5.649120083e-07, 1.3420079092, 4.1137208642, 0.033225034765);

	checkEigenzone(r.eigenzones, -1.9152810036, -0.16644848768, 0.24090519398, 3.7903006498, 0.051929192398);

	checkEigenzone(r.eigenzones, 19.791803187, 5.3159704823, 1.1569824945, 3.6377131372, 0.050356905547);
